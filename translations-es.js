...
const TRANSLATIONS_ES = {
  profile: {
    ...
    bio: `Comencé como <span class="bio-highlight">Ingeniero de Desarrollo de Videojuegos</span> con pasión por crear experiencias divertidas y pulidas. Con el tiempo he desempeñado muchos roles—desde <span class="bio-highlight">desarrollador indie en solitario</span> construyendo prototipos de juegos y enseñando prototipado de videojuegos, hasta <span class="bio-highlight">liderar y co-dirigir equipos de ingeniería</span> para lanzamientos comerciales y profesionales, hasta arquitectar <span class="bio-highlight">enjambres de IA full-stack</span> y sistemas clínicos.

En esencia, soy un <span class="bio-highlight">Ingeniero de Videojuegos y Líder Técnico</span> que ama conectar la mecánica creativa con la ingeniería técnica robusta. Estoy profundamente obsesionado con el <span class="bio-highlight">gamefeel</span>—el arte invisible de añadir 'jugo' al gameplay, desde ajustar inputs con precisión de frame y pesados hit-stops hasta diseñar expresivas <span class="bio-highlight">físicas blandas y pantallazos</span> que hacen que simplemente moverse en pantalla se sienta satisfactorio.

Mi trabajo abarca <span class="bio-highlight">ingeniería de sistemas, juegos de alto rendimiento</span> y <span class="bio-highlight">arquitecturas web full-stack modernas</span>. Ya sea construyendo un <span class="bio-highlight">motor gráfico personalizado en C++</span> con sincronización de escena en tiempo real vía <span class="bio-highlight">Nvidia Omniverse</span>, programando apps de computación espacial para <span class="bio-highlight">Apple Vision Pro</span>, o diseñando plataformas React/Python para investigación médica, me enfoco en entregar <span class="bio-highlight">código limpio, altamente estable y optimizado</span>.`,
  ...
  projects: {
    "heaven-crawler": {
      ...
      features: [
        ...
        "COMBATE MODULAR CON BRAZOS MECÁNICOS. Personaliza tu carga, descubre poderosas sinergias y desarrolla un estilo de combate únicamente tuyo — cada brazo puede mejorarse.",
