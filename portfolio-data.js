...
At my core, I'm a <span class="bio-highlight">Game Development Engineer and Technical Lead</span> who loves bridging creative mechanics with robust technical engineering. I'm deeply obsessed with <span class="bio-highlight">gamefeel</span> — the invisible art of adding 'juice' to gameplay, from frame-perfect inputs and heavy hit-stops to expressive <span class="bio-highlight">wobbly physics and screenshakes</span> that make simply moving on screen feel satisfying.

My work spans <span class="bio-highlight">systems engineering, crazy fun games,</span> and <span class="bio-highlight">modern full-stack architectures</span>. Whether I'm building a <span class="bio-highlight">custom C++ graphics engine</span> with live scene synchronization via <span class="bio-highlight">Nvidia Omniverse</span>, or designing React/Python platforms for medical research, I focus on delivering <span class="bio-highlight">clean, highly stable, and optimized code</span>.

Let's work together — if you can imagine it, I can make it real.`,
